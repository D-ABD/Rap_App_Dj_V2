# Generated by Django 4.2.7 on 2025-08-29 16:25
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('superadmin', 'Super administrateur'), ('admin', 'Administrateur'), ('stagiaire', 'Stagiaire'), ('staff', 'Membre du staff'), ('test', 'Test'), ('candidat', 'Candidat'), ('candidatuser', 'Candidat validé')], db_index=True, default='stagiaire', help_text="Rôle ou niveau d'accès de l'utilisateur", max_length=20, verbose_name='Rôle')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('statut', models.CharField(choices=[('transmis', 'Transmis au partenaire'), ('en_attente', 'En attente de réponse'), ('accepte', 'Accepté'), ('refuse', 'Refusé'), ('annule', 'Annulé'), ('a_faire', 'À faire'), ('contrat a signer', 'Contrat à signer'), ('contrat en attente', 'Contrat en attente'), ('appairage ok', 'Appairage OK')], default='transmis', max_length=20, verbose_name="Statut de l'appairage")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('compte_utilisateur', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='candidat_associe', to=settings.AUTH_USER_MODEL, verbose_name='Compte utilisateur')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, editable=False, help_text="Utilisateur ayant créé l'enregistrement", null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='created_%(class)s_set', to=settings.AUTH_USER_MODEL, verbose_name='Créé par')),
                ('formation', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='prospections', to='rap_app.formation', verbose_name='Formation')),
                ...
                ('partenaire', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='prospections', to='rap_app.partenaire', verbose_name='Partenaire')),
                ('updated_by', models.ForeignKey(blank=True, help_text="Dernier utilisateur ayant modifié l'enregistrement", null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='updated_%(class)s_set', to=settings.AUTH_USER_MODEL, verbose_name='Modifié par')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mois', models.PositiveSmallIntegerField(choices=[(1, 'Janvier'), (2, 'Février'), (3, 'Mars'), (4, 'Avril'), (5, 'Mai'), (6, 'Juin'), (7, 'Juillet'), (8, 'Août'), (9, 'Septembre'), (10, 'Octobre'), (11, 'Novembre'), (12, 'Décembre')], default=8, help_text="Mois de l'année (1-12)", verbose_name='Mois')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('statut', models.CharField(choices=[('transmis', 'Transmis au partenaire'), ('en_attente', 'En attente de réponse'), ('accepte', 'Accepté'), ('refuse', 'Refusé'), ('annule', 'Annulé'), ('a_faire', 'À faire'), ('contrat a signer', 'Contrat à signer'), ('contrat en attente', 'Contrat en attente'), ('appairage ok', 'Appairage OK')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('candidats', models.ManyToManyField(blank=True, help_text='Candidats liés à cet atelier', related_name='ateliers_tre', to='rap_app.candidat', verbose_name='Candidats inscrits')),
                ('centre', models.ForeignKey(blank=True, help_text='Centre où se déroule la formation', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='ateliers_tre', to='rap_app.centre', verbose_name='Centre de formation')),
                ('created_by', models.ForeignKey(blank=True, editable=False, help_text="Utilisateur ayant créé l'enregistrement", null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='created_%(class)s_set', to=settings.AUTH_USER_MODEL, verbose_name='Créé par')),
                ('updated_by', models.ForeignKey(blank=True, help_text="Dernier utilisateur ayant modifié l'enregistrement", null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='updated_%(class)s_set', to=settings.AUTH_USER_MODEL, verbose_name='Modifié par')),
            ],
            options={
