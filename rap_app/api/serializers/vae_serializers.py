...
class VAESerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        extra_kwargs = {
            ...
            "commentaire": {
                "help_text": "Remarques ou informations complémentaires",
                "required": False,
                "allow_blank": True,
            },
        }
...
class ChangerStatutVAESerializer(serializers.Serializer):
    statut = serializers.ChoiceField(
        choices=VAE.STATUT_CHOICES, help_text="Nouveau statut à affecter à la VAE"
    )
    ...
    commentaire = serializers.CharField(
        required=False, allow_blank=True, help_text="Commentaire associé au changement de statut"
    )
